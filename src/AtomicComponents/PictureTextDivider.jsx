...
const PictureTextDivider = ({imageUrl, imageContainerClassNames, imageClassNames, imageFirst = false, children, bgColor}) => {
  return (
    <div className={`flex ${imageFirst ? "flex-row sm:flex-col-reverse" : "flex-row-reverse sm:flex-col-reverse"} ${bgColor} px-[10.2%] sm:px-xpadding items-center pt-0 py-[107px] gap-[97px]`}>
